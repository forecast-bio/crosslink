...
impl FromStr for IssueStatus {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            other => anyhow::bail!("Invalid status '{}'. Valid values: open, closed, archived", other),
        }
    }
}
...
impl FromStr for Priority {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            other => anyhow::bail!("Invalid priority '{}'. Valid values: low, medium, high, critical", other),
        }
    }
}
