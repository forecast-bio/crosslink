...
use merge::{write_root_gitignore, write_mcp_json_merged, write_settings_json_merged};
use walkthrough::{run_tui_walkthrough, apply_tui_choices, setup_shell_alias};

// Section markers re-exported from merge module (used by tests)
use merge::{GITIGNORE_SECTION_START, GITIGNORE_SECTION_END};
...
use crate::commands::config_registry::{ConfigGroup, ConfigType, WalkthroughCore, PRESET_SOLO, PRESET_TEAM, REGISTRY};
