...
| Command | Description |
|---------|-------------|
| `crosslink prune` | Prune git history on coordination branches |
| `crosslink prune --hub` | Squash hub branch history |
| `crosslink prune --knowledge` | Squash knowledge branch history |
| `crosslink prune --before <date>` | Only prune commits before date |
...
| Command | Description |
|---------|-------------|
| `crosslink serve` | Start the web dashboard HTTP server |
| `crosslink serve --port <port>` | Port to listen on (default: 3000) |
| `crosslink serve --open` | Open browser automatically |
